...
public class Score {
    ...
    public Score() {
    	this.playerName = SokobanGame.getInstance().getUsername();
    	if(playerName == null) {
    ...
    public int getPlayerScore() {
    	return MAX_SCORE-SokobanGame.getInstance().getPlayer().getMoves();
    }
    ...
    public int getLevelNumber() {
    	return SokobanGame.getInstance().getLevelNumber();
    }
