...
//		return new Dimension(N_SQUARES_WIDTH, N_SQUARES_HEIGHT);
    ...
    /**
     * Setter for the Image Icon of the frame
     *
     * @param path Path of the image to be set as the application image icon (will be displayed as a frame image icon in the
     *             top left corner and in the taskbar)
     */
